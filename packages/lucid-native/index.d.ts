...
export declare function locationAssociationStrength(currentCount: number, sameTask: boolean, sameActivity: boolean, config?: JsLocationConfig | undefined | null): number
